      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-4"
            ...
            বাংলাদেশের মাটির সংকট ও<br />
            <span style={{ color: '#D4A017' }}>আমাদের সমাধান</span>
          </h2>
        </motion.div>
          ...
          <motion.div
            ...
            <div className="flex items-center gap-3 mb-7">
              ...
              <h3 className="text-xl font-bold" style={{ color: '#dc2626', fontFamily: 'var(--font-hind)' }}>
                বাংলাদেশের মাটির উর্বরতা কেন কমছে?
              </h3>
            </div>
              ...
              {problems.map((p, i) => (
                <motion.li
                  ...
                  <span className="text-base leading-relaxed"
                    style={{ color: '#374151', fontFamily: 'var(--font-hind)' }}>{p.text}</span>
                </motion.li>
              ))}
            </ul>
          ...
          <motion.div
            ...
            <div className="flex items-center gap-3 mb-7">
              ...
              <h3 className="text-xl font-bold" style={{ color: '#1B4D3E', fontFamily: 'var(--font-hind)' }}>
                প্যারাগন জৈব সার কীভাবে কাজ করে?
              </h3>
            </div>
            ...
            <ul className="space-y-4">
              {solutions.map((s, i) => (
                <motion.li
                  ...
                  <span className="text-base leading-relaxed"
                    style={{ color: '#374151', fontFamily: 'var(--font-hind)' }}>{s.text}</span>
                </motion.li>
              ))}
            </ul>
