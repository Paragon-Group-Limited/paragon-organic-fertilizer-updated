  ...
  components: {
    ...
    HowItWorksBlock: {
      ...
      fields: {
        ...
        headingBn: richTextField('Heading (বাংলা)'), headingEn: richTextField('Heading (English)'),
        highlightText: richTextField('Highlighted Text (বাংলা)'), highlightTextEn: richTextField('Highlighted Text (English)'),
        step1No: richTextField('Step 1 Number'), step1Icon: { type: 'text', label: 'Step 1 Icon (emoji)' },
        ...
        step2No: richTextField('Step 2 Number'), step2Icon: { type: 'text', label: 'Step 2 Icon (emoji)' },
        ...
        step3No: richTextField('Step 3 Number'), step3Icon: { type: 'text', label: 'Step 3 Icon (emoji)' },
        ...
        step4No: richTextField('Step 4 Number'), step4Icon: { type: 'text', label: 'Step 4 Icon (emoji)' },
    ...
    ProductsPreviewBlock: {
      ...
      fields: {
        ...
        headingBn: richTextField('Heading (বাংলা)'), headingEn: richTextField('Heading (English)'),
        highlightText: richTextField('Highlighted Text (বাংলা)'), highlightTextEn: richTextField('Highlighted Text (English)'),
        allProductsHref: { type: 'text', label: '"সব পণ্য" Link' },
        p1Name: richTextField('Product 1 Name (বাংলা)'), p1NameEn: richTextField('Product 1 Name (English)'),
        p1Desc: richTextField('Product 1 Description (বাংলা)'), p1DescEn: richTextField('Product 1 Description (English)'),
        p1Weight: richTextField('Product 1 Weight/Size'), p1Icon: { type: 'text', label: 'Product 1 Icon (emoji)' },
        p1Tag: richTextField('Product 1 Tag'), p1Gradient: { type: 'text', label: 'Product 1 Gradient' },
        p1Featured: { type: 'radio', label: 'Featured?', options: [{ label: 'Yes', value: true }, { label: 'No', value: false }] },
        p2Name: richTextField('Product 2 Name (বাংলা)'), p2NameEn: richTextField('Product 2 Name (English)'),
        p2Desc: richTextField('Product 2 Description (বাংলা)'), p2DescEn: richTextField('Product 2 Description (English)'),
        p2Weight: richTextField('Product 2 Weight/Size'), p2Icon: { type: 'text', label: 'Product 2 Icon (emoji)' },
        p2Tag: richTextField('Product 2 Tag'), p2Gradient: { type: 'text', label: 'Product 2 Gradient' },
        p3Name: richTextField('Product 3 Name (বাংলা)'), p3NameEn: richTextField('Product 3 Name (English)'),
        p3Desc: richTextField('Product 3 Description (বাংলা)'), p3DescEn: richTextField('Product 3 Description (English)'),
        p3Weight: richTextField('Product 3 Weight/Size'), p3Icon: { type: 'text', label: 'Product 3 Icon (emoji)' },
        p3Tag: richTextField('Product 3 Tag'), p3Gradient: { type: 'text', label: 'Product 3 Gradient' },
      },
      defaultProps: {
        ...
        p1Name: 'প্যারাগন জৈব সার', p1NameEn: 'Paragon Organic Fertilizer',
        p1Desc: 'উপকারী অণুজীব সমৃদ্ধ ১০০% অর্গানিক সার। মাটির উর্বরতা বৃদ্ধি ও ফসলের স্বাভাবিক বৃদ্ধির জন্য।',
        p1DescEn: '100% organic fertilizer enriched with beneficial microorganisms. For increasing soil fertility and natural crop growth.',
        p1Weight: '৫০ কেজি', p1Icon: '🌿', p1Tag: 'সেরা বিক্রি', p1Gradient: 'linear-gradient(135deg, #1B4D3E 0%, #2D7A3A 100%)', p1Featured: true,
        p2Name: 'জৈব কীটনাশক', p2NameEn: 'Organic Pesticide',
        p2Desc: 'প্রাকৃতিক উপাদান দিয়ে তৈরি পরিবেশবান্ধব কীটনাশক।',
        p2DescEn: 'Eco-friendly pesticide made with natural ingredients.',
        p2Weight: '১ লিটার', p2Icon: '🌾', p2Tag: 'নতুন', p2Gradient: 'linear-gradient(135deg, #D4A017 0%, #F5C842 100%)',
        p3Name: 'মাটি উন্নয়নকারী', p3NameEn: 'Soil Improver',
        p3Desc: 'মাটির পিএইচ ঠিক রাখে এবং মাটির গঠন উন্নত করে।',
        p3DescEn: 'Maintains soil pH balance and improves soil structure.',
        p3Weight: '২৫ কেজি', p3Icon: '🏔️', p3Tag: 'জনপ্রিয়', p3Gradient: 'linear-gradient(135deg, #8B5E3C 0%, #C49A6C 100%)',
      },
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
